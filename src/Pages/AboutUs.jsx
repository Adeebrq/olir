...
const AboutUs = () => {
    return (
        <div className="w-full bg-white">
            ...
            <section id="our-story-section" className="py-12 md:py-16 px-6 md:px-16 lg:px-24 max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    {/* Our Story */}
                    <div>
                        <h2 className="text-2xl md:text-3xl font-bold text-[#0B3D4C] mb-4">Our Story</h2>
                        <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-4">
                            Established as Xcellent Care Hospital in 2014, we began with a simple purpose: To provide care that treats people, not just conditions.
                        </p>
                        <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-4">
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        ...
                        <div className="flex flex-col items-start text-left">
                              <div className="flex flex-row items-center gap-6 mb-4">
                                <div className="w-14 h-14 rounded-full bg-[#FFF5F5] flex items-center justify-center flex-shrink-0">
                                ...
                                <h3 className="text-2xl md:text-3xl font-bold text-[#0B3D4C]">Our Vision</h3>
                            </div>
                        ...
                        <div className="flex flex-col items-start text-left">
                                    <div className="flex flex-row items-center gap-6 mb-4">
                                        <div className="w-14 h-14 rounded-full bg-[#F0F7FF] flex items-center justify-center flex-shrink-0">
                                            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <h3 className="text-2xl md:text-3xl font-bold text-[#0B3D4C]">Our Mission</h3>
                                    </div>
                            <p className="text-gray-600 leading-relaxed">
            ...
            <section className="py-12 md:py-16 px-6 md:px-16 lg:px-24 bg-[#FAFAFA]">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_0.8fr] gap-8 lg:gap-16 items-center">
                        <div className="flex items-center justify-center lg:justify-start">
                            <img 
                                src={circleImg} 
                                alt="Olir Hospital" 
                                className="w-full h-auto object-contain rounded-2xl scale-90"
                            />
                        </div>

                        <div className="space-y-6 flex flex-col justify-center lg:-translate-x-[20%]">
                            ...
                            <div className="flex flex-wrap gap-3 mt-6">
                                {["Mobile Stroke Unit", "Dialysis", "Trauma Care", "Insurance Support", "Ventilator"].map((item, index) => (
                                    <span 
                                        key={index}
                                        className="px-4 py-2 bg-gradient-to-r from-[#F0F7FF] to-[#E0F0FF] text-[#0B3D4C] text-sm font-semibold rounded-full shadow-sm border border-blue-100 hover:shadow-md transition-all duration-300 cursor-default"
                                    >
                                        {item}
                                    </span>
                                ))}
